...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt
            .setName("bio")
            .setDescription("A short bio about you")
            .setRequired(true)
        )
        .addStringOption((opt) =>
          opt
            .setName("intention")
            .setDescription(
              "Display your current intention or goal for the month"
            )
            .setRequired(true)
        )
        .addStringOption((opt) =>
          opt
            .setName("affirmation")
            .setDescription("Display your favorite affirmation")
            .setRequired(true)
        )
        .addStringOption((opt) =>
          opt
            .setName("current_read")
            .setDescription("The book you are currently reading")
            .setRequired(true)
        )
        .addStringOption((opt) =>
          opt
            .setName("reading_goal")
            .setDescription("Your reading goal for this year")
            .setRequired(true)
        )
        .addStringOption((opt) =>
          opt
            .setName("favorite_genre")
            .setDescription("Your favorite book genre")
            .setRequired(true)
        )
        .addStringOption((opt) =>
          opt
            .setName("preferred_format")
            .setDescription(
              "Preferred reading format (Physical, eBook, Audiobook, All)"
            )
            .setRequired(true)
        )
        .addStringOption((opt) =>
          opt
            .setName("favorite_author")
            .setDescription("Your favorite author")
            .setRequired(true)
        )
        .addStringOption((opt) =>
          opt
            .setName("gift_list_url")
            .setDescription("Optionally add your Amazon gift list URL")
            .setRequired(false)
        )
    )
    // Edit subcommand
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt.setName("bio").setDescription("Edit your bio").setRequired(false)
        )
        .addStringOption((opt) =>
          opt
            .setName("intention")
        ...
        .addStringOption((opt) =>
          opt
            .setName("current_read")
            .setDescription("Edit your current read")
            .setRequired(false)
        )
        .addStringOption((opt) =>
          opt
            .setName("reading_goal")
            .setDescription("Edit your reading goal for this year")
            .setRequired(false)
        )
        .addStringOption((opt) =>
          opt
            .setName("favorite_genre")
            .setDescription("Edit your favorite genre")
            .setRequired(false)
        )
        .addStringOption((opt) =>
          opt
            .setName("preferred_format")
            .setDescription("Edit your preferred format")
            .setRequired(false)
        )
        .addStringOption((opt) =>
          opt
            .setName("favorite_author")
            .setDescription("Edit your favorite author")
            .setRequired(false)
        )
        .addStringOption((opt) =>
          opt
  ...
  async execute(interaction) {
    console.log(
      "Profile command called in",
      interaction.guild ? "guild" : "DM"
    );
    ...
    if (subcommand === "view") {
          ...
          .setDescription(
            `${
              user.id === interaction.user.id
                ? "You have"
                : `${user.username} has`
            } not set a profile yet.${
              user.id === interaction.user.id
                ? " Use `/profile set` to create one!"
                : ""
            }`
          );
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          {
            name: `${customEmoji} Bio`,
            value: profile.bio || "Not set",
            inline: false,
          },
          {
            name: `${customEmoji} Intention`,
            value: profile.intention || "Not set",
            inline: false,
          },
          {
            name: `${customEmoji} Affirmation`,
            value: profile.affirmation || "Not set",
            inline: false,
          },
          {
            name: `${customEmoji} Current Read`,
            value: profile.currentRead || "Not set",
            inline: false,
          },
          {
            name: `${customEmoji} Reading Goal`,
            value: profile.readingGoal
              ? profile.readingGoal.toString()
              : "Not set",
            inline: false,
          },
          {
            name: `${customEmoji} Favorite Genre`,
            value: profile.favoriteGenre || "Not set",
            inline: false,
          },
          {
            name: `${customEmoji} Preferred Format`,
            value: profile.preferredFormat || "Not set",
            inline: false,
          },
          {
            name: `${customEmoji} Favorite Author`,
            value: profile.favoriteAuthor || "Not set",
            inline: false,
          },
          {
            name: `${customEmoji} Member Since`,
    ...
    if (subcommand === "set") {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          "Your profile has been created or updated successfully."
        );
      return interaction.reply({ embeds: [embed] });
    }
